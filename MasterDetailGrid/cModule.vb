...
#Region "CustomGrid"
    ...
    Sub applyGridTheme(ByRef grid As DataGridView)
        ...
        REM grid.BackgroundColor = System.Drawing.SystemColors.Window
        REM grid.BorderStyle = System.Windows.Forms.BorderStyle.None
        REM grid.ColumnHeadersBorderStyle = System.Windows.Forms.DataGridViewHeaderBorderStyle.[Single]
        REM grid.ColumnHeadersDefaultCellStyle = gridCellStyle
        REM grid.ColumnHeadersHeight = 32
        REM grid.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.DisableResizing
        REM grid.DefaultCellStyle = gridCellStyle2
        REM grid.EnableHeadersVisualStyles = False
        REM grid.GridColor = System.Drawing.SystemColors.GradientInactiveCaption
        grid.ReadOnly = True
        grid.RowHeadersVisible = True
        REM grid.RowHeadersBorderStyle = System.Windows.Forms.DataGridViewHeaderBorderStyle.[Single]
        REM grid.RowHeadersDefaultCellStyle = gridCellStyle3
        REM grid.Font = gridCellStyle.Font
    End Sub
    Sub setGridRowHeader(ByRef dgv As DataGridView, Optional ByVal hSize As Boolean = False)
        REM dgv.TopLeftHeaderCell.Value = "NO "
